    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl p-5 shadow border">
        ...
        <div className="space-y-4 mb-5">
          {/* Principal */}
          <div>
            <label className="text-xs text-gray-500 uppercase">Principal Balance</label>
            {isProUser ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-xs text-gray-500 uppercase">Current ROI (%)</label>
              {isProUser ? (
                <input 
                ...
                <div className={`mt-1 border rounded-xl px-4 py-3 font-semibold ${blurClass}`}>{formData.currentROI}%</div>
              )}
            </div>
            <div>
              <label className="text-xs text-gray-500 uppercase">Remaining (Yrs)</label>
              {isProUser ? (
                <input 
                  type="number" 
                ...
                <div className={`mt-1 border rounded-xl px-4 py-3 font-semibold ${blurClass}`}>{formData.remainingYears}</div>
              )}
            </div>
          </div>
          ...
          <div>
            <div className="flex justify-between items-center">
              <label className="text-xs text-gray-500 uppercase">CIBIL Score</label>
              {isProUser && (
            ...
            {isProUser ? (
              ...
              <div className={`mt-1 border rounded-xl px-4 py-3 font-semibold flex items-center gap-2 ${blurClass}`}>
                <Shield size={16} className="text-gray-400" /> {formData.cibilScore}
              </div>
            )}
          </div>
        </div>
